# EfficiencyRaceUI_EfficiencyRaceBanner 施工原型说明

> 对应 prefab：`Assets/Prefabs/UI/Panels/EfficiencyRaceUI_EfficiencyRaceBanner.prefab`  
> 画布：1080 x 1920 竖屏  
> 原型文件：`ui_layout_prototype_EfficiencyRaceUI_EfficiencyRaceBanner.svg`
...
本轮会生成 `ui_layout_prototype_EfficiencyRaceUI_EfficiencyRaceBanner.png`，目标尺寸为 1080x1920。