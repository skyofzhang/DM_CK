...
▌顶部标题区（top:80px，居中）
- 主标题："极地生存法则"，font-size:88px，font-weight:900，
...
主标题（距中心上移280px）：
- "极地生存法则"，font-size:96px，font-weight:900
...
▌底部小字（bottom:80px，居中）
"© 极地生存法则 · 抖音直播互动"，font-size:22px，color:#4A9ECC，opacity:0.35
...
【界面】极地生存法则 · 实时贡献榜（展示完整面板设计，以HUD为背景）
...
【界面】极地生存法则 · 结算A屏（游戏结束第一屏：展示胜利/失败结果）
...
【界面】极地生存法则 · 结算B屏（游戏结束第二屏：本局详细数据统计）
...
【界面】极地生存法则 · 结算C屏（第三屏：Top3英雄榜+MVP）
...
【界面】极地生存法则 · 全屏公告弹窗（展示游戏开始、怪物来袭、胜利/失败公告三种变体）
...
【界面】极地生存法则 · VIP大额礼物全屏公告（T5传说礼物触发）
...
【界面】极地生存法则 · 玩家加入通知（展示通知胶囊在HUD中的效果，连续弹出多条）
...
【界面】极地生存法则 · 冻结/暴风雪状态横幅（在HUD中间显示的全宽警告）
...
【界面】极地生存法则 · 7种礼物通知横幅对照（展示所有礼物级别的视觉差异）
