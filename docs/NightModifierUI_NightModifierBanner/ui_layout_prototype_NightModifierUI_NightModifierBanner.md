# NightModifierUI_NightModifierBanner 施工原型说明

> 对应 prefab：`Assets/Prefabs/UI/Panels/NightModifierUI_NightModifierBanner.prefab`  
> 画布：1080 x 1920 竖屏  
> 原型文件：`ui_layout_prototype_NightModifierUI_NightModifierBanner.svg`
...
本轮会生成 `ui_layout_prototype_NightModifierUI_NightModifierBanner.png`，目标尺寸为 1080x1920。