# TensionOverlayUI_TensionOverlay 施工原型说明

> 对应 prefab：`Assets/Prefabs/UI/Panels/TensionOverlayUI_TensionOverlay.prefab`  
> 画布：1080 x 1920 竖屏  
> 原型文件：`ui_layout_prototype_TensionOverlayUI_TensionOverlay.svg`
...
本轮会生成 `ui_layout_prototype_TensionOverlayUI_TensionOverlay.png`，目标尺寸为 1080x1920。